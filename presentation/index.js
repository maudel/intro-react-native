    ...
    return (
      <Deck transition={["zoom", "slide"]} theme={theme} transitionDuration={500}>
        ...
        <Slide transition={["zoom", "fade"]} bgColor="primary">
          <Heading size={2} textColor='tertiary'>Que es react-native?</Heading>
          <List>
            <Appear><ListItem>Desarrollo Multiplataforma</ListItem></Appear>
            <Appear><ListItem>Soporta Android y Ios</ListItem></Appear>
            <Appear><ListItem>De verdad Nativo- no solo un web view</ListItem></Appear>
          </List>
        </Slide>
        ...
        <Slide transition={["zoom", "fade"]} bgColor="primary">
          ...
          <List>
             <Appear><ListItem> Una forma eficaz de construir interfaces de usuario </ListItem></Appear>
             <Appear><ListItem> Basado en el concepto de Componentes </ListItem></Appear>
             <Appear><ListItem> Una biblioteca de JavaScript utilizada y desarrollada por Facebook </ListItem></Appear>
             <Appear><ListItem> Open Source </ListItem></Appear>
          </List>
        </Slide>

        <Slide transition={["zoom", "fade"]} bgColor="primary">
          <Heading size={2} textColor='black'>Ejemplo</Heading>
        </Slide>
        ...
        <Slide transition={["zoom", "fade"]} bgColor="primary">
        <Heading size = {4} textColor = 'black'> Configurando componentes </Heading>
           <Heading size = {6} textColor = 'tertiary'> props </Heading>
        ...
        <Slide transition={["zoom", "fade"]} bgColor="primary">
           <Heading size = {4} textColor = 'black'> Más props </Heading>
           <Heading size = {6} textColor = 'tertiary'> Componentes para nuestros modelos </Heading>
        </Slide>
        ...
        <Slide transition={["zoom", "fade"]} bgColor="primary">
          ...
          <List>
          <Appear><ListItem> Componentes predeterminados de React: View, Text, Image, etc. </ListItem></Appear>
             <Appear><ListItem> Compatibilidad con hojas de estilo, incluido flexbox </ListItem></Appear>
             <Appear><ListItem>Animaciones</ListItem></Appear>
             <Appear><ListItem>Navegacion</ListItem></Appear>
             <Appear><ListItem> Soporte XHR / AJAX </ListItem></Appear>
          </List>
        </Slide>

        <Slide>
          <Heading size={5}>Componentes Utiles</Heading>
          <NativeExample code={`
import React from 'react';
...
AppRegistry.registerComponent('AwesomeProject', () => JustifyContentBasics);
        ...
        <Slide transition={["slide"]}>
          ...
          <List>
            <Appear>
              <ListItem>Fetch API </ListItem></Appear>
...
`.trim()}
        ...
        <Slide transition={["slide"]}>
          ...
          <Appear>
            <Text>
            Recuerda: ¡es una verdadera aplicación para Android / iOS!
             </Text>
          </Appear>
        </Slide>
...
             <Appear><ListItem> Cobertura de código incorporada </ListItem></Appear>
             <Appear><ListItem> Corredor de pruebas paralelas </ListItem></Appear>
             <Appear><ListItem> Funciones de imitación, importaciones, llamadas de red </ListItem></Appear>
             <Appear><ListItem> Jasmine </ListItem></Appear>
          </List>
        </Slide>
        ...
        <Slide transition={["slide"]}>
          ...
          <List>
             <Appear><ListItem> Animaciones - Preclasificadas y optimizadas de forma nativa </ListItem></Appear>
             <Appear><ListItem> Reduce re-renders </ListItem></Appear>
             <Appear><ListItem> reaccion-native-workers / native </ListItem></Appear>
             <Appear><ListItem> Herramientas de rendimiento integradas </ListItem></Appear>
...
             <Appear><ListItem> Envuelva una API de Java / iOS existente </ListItem></Appear>
...
             <Appear><ListItem> wix - reaccion-native-navigation </ListItem></Appear>
             <Appear><ListItem> aksonov - reaccion-native-router-flux </ListItem></Appear>
             <Appear><ListItem> ReactTraining - react-router (4.0 beta) </ListItem></Appear>
             <Appear><ListItem> exponent - ex-navigator </ListItem></Appear>
             <Appear><ListItem> airbnb - No tiene código abierto </ListItem></Appear>
          </List>
        </Slide>
